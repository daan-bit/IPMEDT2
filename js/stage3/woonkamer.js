...
stage.onscroll = function(event){
    ...
    if (mediaQueryTablet.matches){
        if (scroll <= maxScroll*0.10){
            room.setAttribute("href", "../Stage3/stage3-toilet.html");
            room.innerHTML = "Toilet";
        }
        else if (scroll > maxScroll*0.10 && scroll < maxScroll*0.25){
            room.setAttribute("href", "../Stage3/stage3-woonkamer-gesprek.html");
            room.innerHTML = "Woonkamer";
        }
        else {
            room.setAttribute("href", "../Stage3/stage3-buiten.html");
