...
stage.onscroll = function(event){
    ...
    if (mediaQueryTablet.matches){
        if (scroll <= maxScroll*0.05){
            room.setAttribute("href", "../Stage1/stage1-toilet.html");
            room.innerHTML = "Toilet";
        }
        else if (scroll > maxScroll*0.05 && scroll < maxScroll*0.10){
            room.setAttribute("href", "../Stage1/stage1-woonkamer-gesprek.html");
            room.innerHTML = "Woonkamer";
        }
        else {
            room.setAttribute("href", "../Stage1/stage1-buiten.html");
...
typeText(Array.from("Jij staat nog binnen er zijn nog wat kennissen in de woonkamer. Je kan ook naar de WC gaan want je moet ook wel pissen of je kan naar buiten gaan waar James en je vrienden zijn."));
